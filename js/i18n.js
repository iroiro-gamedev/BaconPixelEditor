...
export const I18N = {
  en: {
    ...
    'm.help':'Help','m.tutorial':'Tutorial','m.terms':'Terms of Service','m.privacy':'Privacy Policy','m.about':'About',
    'help.close':'Close',
    ...
    'help.termsOwnershipTitle':'Ownership of Created Content','help.termsOwnership':'All images and content created using Bacon Pixel Editor are the exclusive property of the user who created them. The Service claims no rights over user-created content.',
    'help.termsUsageTitle':'Usage','help.termsUsage':'The Service may be used free of charge for both personal and commercial purposes.',
    'help.termsDisclaimerTitle':'Disclaimer','help.termsDisclaimer':'The Service is provided "as is" without any warranty. The operator is not liable for any damages arising from use of the Service.',
    'help.termsChangeTitle':'Changes to Terms','help.termsChange':'These terms may be updated without prior notice. Continued use of the Service constitutes acceptance of the revised terms.',
  ...
  ja: {
    ...
    'm.help':'ヘルプ','m.tutorial':'チュートリアル','m.terms':'利用規約','m.privacy':'プライバシーポリシー','m.about':'このアプリについて',
    'help.close':'閉じる',
    ...
    'help.termsTitle':'利用規約',
    'help.termsOwnershipTitle':'作成コンテンツの権利','help.termsOwnership':'Bacon Pixel Editor で作成した画像・コンテンツの著作権はすべて作成者（ユーザー）に帰属します。当サービスはいかなる権利も主張しません。',
    'help.termsUsageTitle':'利用条件','help.termsUsage':'本サービスは個人・商用目的を問わず無償で利用できます。',
    'help.termsDisclaimerTitle':'免責事項','help.termsDisclaimer':'本サービスは現状のまま提供されます。利用によって生じたいかなる損害についても、運営者は責任を負いません。',
    'help.termsChangeTitle':'規約の変更','help.termsChange':'本規約は予告なく変更される場合があります。変更後も本サービスをご利用の場合は、変更後の規約に同意したものとみなします。',
  ...
  zh: {
    ...
    'm.help':'帮助','m.tutorial':'教程','m.terms':'使用条款','m.privacy':'隐私政策','m.about':'关于',
    'help.close':'关闭',
    ...
    'help.privTitle':'隐私政策',
    'help.termsTitle':'使用条款',
    'help.termsOwnershipTitle':'创作内容的权利','help.termsOwnership':'使用 Bacon Pixel Editor 创作的所有图像和内容的版权均归创作者（用户）所有。本服务不主张任何权利。',
    'help.termsUsageTitle':'使用条件','help.termsUsage':'本服务可免费用于个人或商业目的。',
    'help.termsDisclaimerTitle':'免责声明','help.termsDisclaimer':'本服务按"现状"提供，不提供任何形式的保证。因使用本服务而产生的任何损失，运营者概不负责。',
    'help.termsChangeTitle':'条款变更','help.termsChange':'本条款可能在不预先通知的情况下更新。继续使用本服务即表示接受修订后的条款。',
